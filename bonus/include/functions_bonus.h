...
// Check extension
int					extension_check(char *file, char *extension);
...
// Parse ------------------------------------------------
// Line parse
int					parse_line(char *line, t_list_elem *list_elem, void *mlx);
...
// Format
int					parse_plane(char *line, t_elem **elem, void *mlx);
int					parse_sphere(char *line, t_elem **elem, void *mlx);
int					parse_cylinder(char *line, t_elem **elem, void *mlx);
int					parse_cone(char *line, t_elem **elem, void *mlx);
...
// UV mapping when applying texture to the objects
// Checker pattern
...
void				normal_cn(t_elem *elem, t_tuple obj_p, t_tuple *tup);
...
// Get the color of the pixel at a specified location
...
// Cone:
void				intersect_cn(t_elem *elem, t_ray *ray,
						t_intersect_list *i_list);

// Light ------------------------------------------------

t_material			material(void);
void				set_ambient(t_ambient *ambient, t_elem *elem,
						int quant);
